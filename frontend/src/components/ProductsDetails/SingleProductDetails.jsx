...
async function getProductdetails(id){
  ...
  let {data} = await axios.get(`http://127.0.0.1:8000/all_products/${id}`)
  setProduct(data)
  // setImage(data.image)
              ...
              <p className='text-3xl capitalize'>{productDetail.desc}</p>
                  ...
                  <div className='flex flex-col text-white gap-10 p-5 rounded-sm benefits-box'>
                    <div className='flex flex-row gap-3'>
                        <i className="fa-solid fa-dolly text-5xl benefits-box-icon"></i>
                    ...
                    <div className='flex flex-row gap-3'>
                        <i className="fa-solid fa-store text-5xl benefits-box-icon"></i>
                      <div className='flex flex-col items-start'>
